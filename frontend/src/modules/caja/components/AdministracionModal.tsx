...
export function AdministracionModal({ onCerrar, onActualizar }: AdministracionModalProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-2 sm:p-4">
      <div className="w-full max-w-sm rounded-lg bg-white shadow-lg dark:bg-brand-green-900 sm:max-w-2xl lg:max-w-5xl">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-brand-vanilla-dark p-4 dark:border-brand-green-700">
        ...
        {/* Content */}
        <div className="overflow-y-auto p-4 sm:p-6 lg:grid lg:grid-cols-2 lg:gap-6">
        ...
        <div className="border-t border-brand-vanilla-dark p-4 dark:border-brand-green-700">
          <button
            onClick={onCerrar}
